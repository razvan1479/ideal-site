// /api/contact — botul TAU iti trimite in DM ce a scris utilizatorul.
// Daca userul a pus User ID numeric, mesajul are si un buton "Reply on Discord".
// Env: DISCORD_BOT_TOKEN + DISCORD_USER_ID. Botul trebuie sa fie intr-un server
// comun cu tine si tu sa ai DM-urile deschise, altfel Discord da 403.
export default async function handler(req, res) {
  ...
  try {
    ...
    const msg = await fetch(`https://discord.com/api/v10/channels/${ch.id}/messages`, {
      method: "POST", headers: { Authorization: `Bot ${TOKEN}`, "Content-Type": "application/json" },
